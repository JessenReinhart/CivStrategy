...
## First target: world/bootstrap composition
...
The first refactor should therefore extract **construction and wiring**, not move gameplay logic into another god-class. The resulting `MainScene` should remain the Phaser lifecycle boundary while a bootstrap/composition helper owns dependency assembly.
