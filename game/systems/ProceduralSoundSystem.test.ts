...
describe('ProceduralSoundSystem — audio node graph (P0)', () => {
    ...
    const methods: Array<[string, () => void, number]> = [
        ...
        ['playDeath (unit)', () => sound.playDeath(100, 100, 'LEGION'), 0],
        ['playDeath (animal)', () => sound.playDeath(100, 100, 'deer'), 0],
        ['playDeath (default)', () => sound.playDeath(100, 100), 0],
        ...
        ['playAttackImpact (HACK)', () => sound.playAttackImpact(100, 100, 'Hack'), 0],
        ['playAttackImpact (PIERCE)', () => sound.playAttackImpact(100, 100, 'Pierce'), 0],
        ['playAttackImpact (CRUSH)', () => sound.playAttackImpact(100, 100, 'Crush'), 0],
        ['playAttackImpact (default)', () => sound.playAttackImpact(100, 100), 0],
        ['playSiegeImpact', () => sound.playSiegeImpact(100, 100), 0],
