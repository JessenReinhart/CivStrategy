...
export type BuildingSpriteVisualConfig = {
    ...
    /** Width of the shadow's contact edge relative to the rendered sprite width. */
...
export const BUILDING_SPRITE_VISUALS: Record<BuildingType, BuildingSpriteVisualConfig> = {
    [BuildingType.TOWN_CENTER]: {
        ...
        shadowHeightScale: 1.0, shadowFootprintScale: 0.90, shadowAnchorOffsetY: 5, shadowEndWidthScale: 0.58,
    },
    [BuildingType.HOUSE]: {
        key: 'house', scaleMultiplier: 1.6, originY: 0.85,
        shadowHeightScale: 0.72, shadowFootprintScale: 0.96, shadowAnchorOffsetY: 6, shadowEndWidthScale: 0.56,
    },
    [BuildingType.BARRACKS]: {
        key: 'barracks', scaleMultiplier: 1.5, originY: 0.75,
        shadowHeightScale: 0.74, shadowFootprintScale: 0.96, shadowAnchorOffsetY: 5, shadowEndWidthScale: 0.58,
    },
    [BuildingType.FARM]: {
        key: 'field', scaleMultiplier: 1.3, originY: 0.5,
        shadowHeightScale: 0.24, shadowFootprintScale: 0.94, shadowAnchorOffsetY: 2, shadowEndWidthScale: 0.76,
    },
    [BuildingType.LUMBER_CAMP]: {
        key: 'lumber', scaleMultiplier: 1.7, originY: 0.75,
        shadowHeightScale: 0.72, shadowFootprintScale: 0.96, shadowAnchorOffsetY: 5, shadowEndWidthScale: 0.60,
    },
    [BuildingType.HUNTERS_LODGE]: {
        key: 'lodge', scaleMultiplier: 1.6, originY: 0.75,
        shadowHeightScale: 0.68, shadowFootprintScale: 0.94, shadowAnchorOffsetY: 5, shadowEndWidthScale: 0.60,
    },
    [BuildingType.BONFIRE]: {
        key: 'bonfire', scaleMultiplier: 2.1, originY: 0.82,
        shadowHeightScale: 0.18, shadowFootprintScale: 0.70, shadowAnchorOffsetY: 3, shadowEndWidthScale: 0.72,
    },
    [BuildingType.SMALL_PARK]: {
        key: 'park', scaleMultiplier: 1.5, originY: 0.82,
        shadowHeightScale: 0.24, shadowFootprintScale: 0.88, shadowAnchorOffsetY: 3, shadowEndWidthScale: 0.72,
    },
    [BuildingType.MARKET]: {
    ...
    [BuildingType.WALL]: {
        ...
        shadowHeightScale: 0.62, shadowFootprintScale: 0.90, shadowAnchorOffsetY: 4, shadowEndWidthScale: 0.68,
    },
    [BuildingType.CATHEDRAL]: {
        key: 'cathedral', scaleMultiplier: 1.7, originY: 0.82,
        shadowHeightScale: 1.0, shadowFootprintScale: 0.96, shadowAnchorOffsetY: 7, shadowEndWidthScale: 0.54,
    },
    [BuildingType.CASTLE]: {
        key: 'castle', scaleMultiplier: 1.5, originY: 0.80,
        shadowHeightScale: 1.0, shadowFootprintScale: 0.98, shadowAnchorOffsetY: 8, shadowEndWidthScale: 0.54,
    },
};
