...
export const BUILDING_SPRITE_VISUALS: Record<BuildingType, BuildingSpriteVisualConfig> = {
    ...
    [BuildingType.BONFIRE]: { key: 'bonfire', scaleMultiplier: 2.1, originY: 0.82 },
    [BuildingType.SMALL_PARK]: { key: 'park', scaleMultiplier: 1.5, originY: 0.82 },
    [BuildingType.MARKET]: { key: 'market', scaleMultiplier: 1.8, originY: 0.78 },
    [BuildingType.WALL]: { key: 'wall', scaleMultiplier: 2.4, originY: 0.76 },
    [BuildingType.CATHEDRAL]: { key: 'cathedral', scaleMultiplier: 1.7, originY: 0.82 },
    [BuildingType.CASTLE]: { key: 'castle', scaleMultiplier: 1.5, originY: 0.80 },
};
